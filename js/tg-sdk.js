...
window.PlatformAPI = {
  ...
  async init() {
    if (window.Telegram && window.Telegram.WebApp) {
      ...
      // ✅ Фолбэк: парсим initData напрямую (работает даже через Menu Button)
  ...
  async buyHint() {
    try {
      ...
      // 2. Фолбэк: парсим initData напрямую (всегда работает в Telegram)
